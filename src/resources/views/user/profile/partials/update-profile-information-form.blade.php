<section>
    <header>
        ...
        <p class="mt-1 text-sm text-red-600">
            {{ __("※注文の際は、郵便番号・住所・配達住所詳細・電話番号が必須です") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('user.profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="zip_code" :value="__('郵便番号※必須')" />
        ...
        <div>
            <x-input-label for="address" :value="__('住所※必須')" />
        ...
        <div>
            <x-input-label for="address_detail" :value="__('配達住所詳細※必須')" />
        ...
        <div>
            <x-input-label for="tel" :value="__('電話番号※必須')" />
